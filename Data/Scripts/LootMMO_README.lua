--[[
	...
	Loot (for Adventurers) NFT collection. In this project, data from NFTs is seen as
	an advantage and provokes interesting design constraints.
	
	The project is community owned and developed.
	Tools, MMO framework and social hub by Manticore Games.
	...
	A starting point for Loot MMO, the social hub has been designed as a cozy space where
	players and builders can meet, discuss Loot and form parties to head off on adventures.
	Doors, maps and other interactive objects double as connection points── portals into
	the experiences created by the community. Where this "home base" evolves will be up to
	everyone to decide.
