...
modifiers['DOT'].calString = "10 + 50 * SP / 156"
...
modifiers['Radius'].calString = "200 + 600 * WIS / 172"
...
--Formula: Min + (Max - Min) * WIS / 172
modifiers['Duration'].calString = "5 + 5 * WIS / 172"
...
modifiers['Slow'].calString = "0.4 + 0.45 * AGI / 172"
