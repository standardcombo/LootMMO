local Settings = {
    ...
    smallBet = 1, -- The small blind that a player will have to pay at the start of round.
    minBuyin = 100, -- The minimum amount of money a player has to have in order to join a table.
    maxBuyin = 2000, -- The max amount of money a player can bring to a table.
    ...
    emoteForMoney = 1, -- Dancing on table will earn money until it reaches the minBuyin amount
}
